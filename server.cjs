...
const { handleSiaChat, handleSiaReelCaptions, handleSiaTranslateText } = require("./api/_storefy-sia.cjs");
...
app.post("/api/assistant/translate-text", handleSiaTranslateText);
